...
$.validator.addMethod( "cifES", function( value, element ) {
	...
	let all_sum = even_sum + odd_sum;
	let control_digit = (10 - parseInt(all_sum.toString().slice(-1), 10)) % 10;
	let control_letter = "JABCDEFGHI".slice(control_digit, control_digit + 1);
