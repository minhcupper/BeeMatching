          ...
          /*  migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NguoiDung_districts_DistrictId",
                    ...
                    table.ForeignKey(
                        name: "FK_NguoiDung_provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "provinces",
                        principalColumn: "code");
                    table.ForeignKey(
                        name: "FK_NguoiDung_wards_WardId",
                        column: x => x.WardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KyNangCongViec_DanhMucKyNang_KyNangId",
                        column: x => x.KyNangId,
                        principalTable: "DanhMucKyNang",
                        principalColumn: "DanhMucKyNangId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NguoiDung_ProvinceId",
                table: "NguoiDung",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_NguoiDung_WardId",
                table: "NguoiDung",
                column: "WardId");
