...
namespace API_He_thong.Controllers
{
    ...
    [ApiController]
    public class KinhNghiemCongViecController : ControllerBase
    {
        private readonly Ikinhnghiemcongviec uS;

        public KinhNghiemCongViecController(Ikinhnghiemcongviec us)
        {
            this.uS = us;
        }
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> PostUser(KinhNghiemCongViec user)
        {
            if (user == null)
            {
        ...
        // PUT: api/User/Edit/5
        [HttpPut("Edit/{id}")]
        public async Task<IActionResult> EditKinhNghiemById(int id, KinhNghiemCongViec user)
        {
